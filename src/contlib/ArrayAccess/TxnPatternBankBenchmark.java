...
public class TxnPatternBankBenchmark extends ArrayAccessTxnMultipleFuture {
	...
	public TxnPatternBankBenchmark(int max_num_of_core, int hot_spot_in_the_array, String high_contention, int spin, int bank_agency_index, int bank_agency_number, float txnPercentages){
