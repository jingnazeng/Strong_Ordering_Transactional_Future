...
public class TxnPattern5By4Futures extends ArrayAccessTxnMultipleFuture {
	VBox<Integer>[] array;
	private int value;
	...
	public TxnPattern5By4Futures(int read, int write, String high_contention, int spin){
