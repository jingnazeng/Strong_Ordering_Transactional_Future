...
public class TxnPattern5By4FuturesSeq extends ArrayAccessTxnMultipleFuture {
	VBox<Integer>[] array;
	private int value;
	...
	public TxnPattern5By4FuturesSeq(int read, int write, String high_contention, int spin){
